...
<div class="request-view">
    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
            ...
            [
                'attribute' => 'date',
                'value' => fn() => Html::encode(Yii::$app->formatter->asDatetime($model->date, 'd.m.Y H:i:s'))
            ], 
            [
                'attribute' => 'created_at',
                'value' => fn() => Html::encode(Yii::$app->formatter->asDatetime($model->created_at, 'd.m.Y H:i:s'))
            ], 
        ],
    ]) ?>
